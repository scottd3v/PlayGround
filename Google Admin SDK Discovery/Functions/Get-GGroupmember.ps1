Function GetGGroupMember {	
    ...
    process {	
        ...
        $Results = InvokeRestMethod Headers @{Authorization = "Bearer $($GSuiteAdminDirectoryToken.access_token)"} Uri $GroupsUri  Method GET ContentType 'application/json'	
